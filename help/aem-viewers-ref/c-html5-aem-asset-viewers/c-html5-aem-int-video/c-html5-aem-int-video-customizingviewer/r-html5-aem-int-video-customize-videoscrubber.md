...
Wanneer de markering van het videohoofdstuk is ingeschakeld met de `navigation` parameter, worden de hoofdstukplaatsen getoond als tellers bovenop het videoscrubberspoor.
...
**Voorbeeld** - Als u een beschrijving van het videohoofdstuk wilt instellen met een donkergrijs, 11-pixel Verdana-lettertype, met een lichtgrijze achtergrond. Een lijnhoogte van vijf pixels, een horizontale opvulling van 12 pixels, een opvulling van 12 pixels boven en een opvulling van negen pixels onder.
