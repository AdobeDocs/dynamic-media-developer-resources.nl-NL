...
>[!NOTE]
>
>Als knopinfo-stijlen worden aangepast vanuit de ingesloten webpagina, moeten alle eigenschappen de eigenschap `!IMPORTANT` regel. Deze regel is niet nodig als knopinfo wordt aangepast in het CSS-bestand van de viewer.
