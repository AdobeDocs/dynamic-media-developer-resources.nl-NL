...
**Voorbeeld** - om een dialoogvenster voor voettekst in te stellen met een knop Annuleren van 64 x 34, met een tekstkleur en een achtergrondkleur die voor elke knopstatus anders zijn:
...
**Voorbeeld** - om tekstkopie in te stellen op 430 pixels breed en onderaan een opvulling van tien pixels te gebruiken:
...
**Voorbeeld** - om de hoogte van de invoervak voor insluiten in te stellen op 40 pixels:
...
**Voorbeeld** - om het deelvenster met invoervak zo in te stellen dat het een grijze rand van één pixel heeft:
...
**Voorbeeld** - om het deelvensteritem voor de keuzelijst met invoervak in te stellen op een witte achtergrond:
...
**Voorbeeld** - om het pictogram van het vinkje in te stellen op 25 x 25 pixels:
...
**Voorbeeld**  - om het deelvenster met invoervelden voor aangepaste grootte in te stellen op 20 pixels rechts van de keuzelijst met invoervak:
...
**Voorbeeld** : om een schuifvenster in te stellen op een breedte van 44 pixels
