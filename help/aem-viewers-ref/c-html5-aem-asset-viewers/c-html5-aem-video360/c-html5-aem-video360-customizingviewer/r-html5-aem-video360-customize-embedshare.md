...
**Voorbeeld** - Dialoogkoptekst instellen met opvulling, pictogram van 24 x 14 pixels en een vette titel van 16 punten. Tot slot een knop Sluiten van 28 x 28 pixels, geplaatst op twee pixels van de bovenkant en twee pixels van de rechterkant van de dialoogcontainer:
...
**Voorbeeld** - om een dialoogvenster voor voettekst in te stellen met een knop Annuleren van 64 x 34, met een tekstkleur en achtergrondkleur die voor elke knopstatus anders zijn:
...
**Voorbeeld** - Insluitcode configureren voor gebruik `break-word` tekstterugloop:
...
**Voorbeeld** - een insluitvenster instellen met tien pixels opvulling:
...
**Voorbeeld** - als u het insluitlabel wilt instellen op de uitlijning boven en 80 pixels breed:
...
**Voorbeeld** - als u het invoervak Grootte insluiten wilt instellen op 300 pixels breed bij het weergeven van een vooraf gedefinieerd item en op 110 pixels breed bij het weergeven van een aangepaste grootte:
...
**Voorbeeld** - om de teksthoogte van het invoervak voor de insluiting in te stellen op 40 pixels:
...
**Voorbeeld** - om een vervolgkeuzelijst in te stellen op 28 x 28 pixels en een aparte afbeelding voor elke status te hebben:
...
**Voorbeeld** - als u het deelvenster voor invoervelden met een aangepaste grootte wilt instellen op 20 pixels rechts van de keuzelijst met invoervelden:
...
**Voorbeeld** - U kunt als volgt de invoervelden van de aangepaste grootte instellen op een grijze rand, marge, opvulling en een breedte van 70 pixels:
...
**Voorbeeld** - om een schuifbalktrack in te stellen die 28 pixels breed is en een grijze achtergrond heeft:
...
**Voorbeeld** - als u een schuifbalkblokje van 28 x 45 pixels wilt instellen, een marge van 10 pixels aan de boven- en onderkant wilt instellen en voor elke staat een andere illustratie wilt gebruiken:
