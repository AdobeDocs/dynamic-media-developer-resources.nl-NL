...
description: Het veranderbare volumeregelaar verschijnt aanvankelijk als knoop die een gebruiker het slimme gewas videospelergeluid laat dempen of dempen.
...
In het bovenstaande codevoorbeeld wordt het volumeniveau ingesteld op `0` op de `mutableVolume` component. Vervolgens wordt dezelfde component gedeactiveerd, zodat deze niet door de eindgebruiker kan worden gebruikt.
