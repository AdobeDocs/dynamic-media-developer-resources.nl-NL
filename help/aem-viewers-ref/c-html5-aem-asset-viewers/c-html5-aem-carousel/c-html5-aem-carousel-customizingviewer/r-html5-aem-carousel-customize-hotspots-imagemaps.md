---
description: In de viewer worden hotspot-pictogrammen weergegeven op de hoofdweergave op plaatsen waar hotspots oorspronkelijk zijn gemaakt in Dynamic Media of AEM Assets, op aanvraag.
seo-description: In de viewer worden hotspot-pictogrammen weergegeven op de hoofdweergave op plaatsen waar hotspots oorspronkelijk zijn gemaakt in Dynamic Media of AEM Assets, op aanvraag.
...
In de viewer worden hotspot-pictogrammen weergegeven op de hoofdweergave op plaatsen waar hotspots oorspronkelijk zijn gemaakt in Dynamic Media of AEM Assets, op aanvraag.
...
<table id="table_DAE7A78AA4A74DC78B2D94F29E8E236B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vulkleur van gebied Afbeeldingskaart. </p> <p>Geef deze kleur op in de <span class="codeph"> indelingen </span>#RRGGBB <span class="codeph"> , </span>RGB(R,G,B) <span class="codeph"> of </span> RGBA(R,G,B,A). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Randstijl van afbeeldingskaart. Moet worden opgegeven als "" <span class="codeph"> width </span> solid color <span class="codeph"> ", waarbij </span>width <span class="codeph"> wordt uitgedrukt in pixels, en </span> color <span class="codeph"> wordt ingesteld als </span> #RRGGBB <span class="codeph"> </span><span class="codeph"> </span><span class="codeph"> </span>, RGB(R,G,B), of RGBA(R,G,B,A). </p> </td> 
  </tr> 
 </tbody> 
</table>
