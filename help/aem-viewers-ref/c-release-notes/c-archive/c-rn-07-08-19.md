...
* Oplossing voor een weergaveprobleem op volledig scherm waarbij de pagina op Apple-apparaten werd geschoven (wordt uitgevoerd op iOS 12 en hoger).
...
* De posterafbeelding kan een fout `max size` krijgen. In dat geval moet u de limietinstelling voor Publiceren via afbeeldingsserver verhogen.
