...
Deze eigenschap is vereist, tenzij `video` wordt gebruikt. Zie [Externe videoondersteuning](../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-external-video-support.md#concept-22c67fee43274a29b28ee16770b1b1f3) onder Video of [Externe videoondersteuning](../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-external-video-support.md#concept-66aa2784f2294794989bad2af74c3760) onder Video360.
...
<table id="table_A2A0ACD942E942BC99AF0DC80FB1C670"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> image </span> </span> </p> </td> 
   <td colname="col2"> <p> Hiermee geeft u één afbeelding op. Dubbele HTTP-codering toepassen op elk onveilig teken in de afbeeldingsnaam. </p> <p>Of geeft een verwijzing naar een afbeeldingsset op. De viewer haalt afbeeldingssets op van de server, met <span class="codeph"> req=set IS </span> verzoek. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Opdrachten Beeldservers; <span class="codeph"> &amp; </span> en <span class="codeph"> = </span> scheidingstekens moeten als HTTP-gecodeerd zijn <span class="codeph"> %26 </span> en <span class="codeph"> %3D </span>, respectievelijk. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
` asset=( *`mediaSet`* | ( *`video`*; *`staalId`* | *`image`*; *`staalId`* | *`setId`*; *`staalId`*); *`ID`*;( *`video`*; *`staalId`* | *`image`*; *`staalId`* | *`setId`*; *`staalId`*); *`ID`*;] [%3F *`modifiers`*]`
