...
>[!NOTE]
>
>Als knopinfo-stijlen worden aangepast vanuit de ingesloten webpagina, moeten alle eigenschappen `!IMPORTANT` regel bevatten. Dit is niet nodig als knopinfo wordt aangepast in het CSS-bestand van de viewer.
