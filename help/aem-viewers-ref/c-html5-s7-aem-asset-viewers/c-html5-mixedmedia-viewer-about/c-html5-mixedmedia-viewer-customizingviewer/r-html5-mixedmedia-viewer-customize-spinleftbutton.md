...
Als u deze knop selecteert, wordt de afbeelding in de hoofdweergave links gecentreerd. Deze knop wordt niet weergegeven op mobiele telefoons om de schermruimte op te slaan. De knop is ook verborgen wanneer een multidimensionale centrifugeset wordt gebruikt. U kunt de grootte, de huid, en de positie van de knoop gebruikend CSS.
...
Voorbeeld - Een linksom draaien-knop van 28 x 28 pixels instellen die op de linkerrand van de binnencontainer wordt geplaatst. En tenslotte, toont een verschillend beeld voor elk van de vier verschillende knoopstaten:
