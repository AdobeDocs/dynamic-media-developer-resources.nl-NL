---
description: Alle visuele aanpassingen en de meeste gedragsaanpassingen voor de Kijker van het Gezoem worden gedaan door een douaneCSS te creëren.
keywords: responsive
seo-description: Alle visuele aanpassingen en de meeste gedragsaanpassingen voor de Kijker van het Gezoem worden gedaan door een douaneCSS te creëren.
seo-title: Zoomviewer aanpassen
...
Houd er bij het maken van aangepaste CSS rekening mee dat de viewer `.s7zoomviewer` klasse toewijst aan het container DOM-element. Als u extern CSS-bestand gebruikt dat met `style=` de opdracht is doorgegeven, gebruikt u `.s7zoomviewer` klasse als bovenliggende klasse in de onderliggende kiezer voor uw CSS-regels. Als u ingesloten stijlen op de webpagina uitvoert, kwalificeert u deze kiezer als volgt aanvullend met een id van het DOM-containerelement:
