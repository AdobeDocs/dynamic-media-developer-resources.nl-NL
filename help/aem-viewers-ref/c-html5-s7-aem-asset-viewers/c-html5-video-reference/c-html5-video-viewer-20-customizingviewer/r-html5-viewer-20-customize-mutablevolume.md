...
In het bovenstaande codevoorbeeld wordt het volumeniveau ingesteld op `0` de `mutableVolume` component. Vervolgens wordt dezelfde component gedeactiveerd, zodat deze niet door de eindgebruiker kan worden gebruikt.
