---
title: Videoscrubber
description: De videoscrubber is de horizontale schuifregelaar waarmee een gebruiker dynamisch kan zoeken naar een willekeurige tijdpositie in de video die momenteel wordt afgespeeld
...
**Voorbeeld** - Een videoviewer instellen met een videoscrubber met aangepaste trackkleuren. De scrubber moet tien pixels hoog zijn en moet zich tien pixels en 35 pixels van de boven- en linkerrand van de besturingsbalk bevinden.
...
Wanneer videochaptering is ingeschakeld met de `navigation` parameter, worden de hoofdstukplaatsen getoond als tellers bovenop het videoscrubberspoor.
...
>[!NOTE]
>
>Deze knop ondersteunt beide `state` kenmerkenkiezer, die u kunt gebruiken om verschillende skins toe te passen op verschillende knoptoestanden. Met name: `selected='default'` komt overeen met de standaardmarkeringsstatus van het videohoofdstuk en `selected='over'` wordt gebruikt wanneer de hoofdstukmarkering van de video wordt geactiveerd door een muis boven of aanraakbeweging.

**Voorbeeld** - U stelt een hoofdstukmarkering voor video in van 5 x 8 pixels en gebruikt verschillende illustraties voor de status &quot;default&quot; en &quot;over&quot;.
...
**Voorbeeld** - Een ballon van een videohoofdstuk instellen die 235 pixels breed is en 8 pixels omhoog van de onderkant van de videoscrubbertrack loopt.
...
**Voorbeeld** - Een bubbelheader van een videohoofdstuk instellen van 22 pixels hoog, een regelhoogte van 22 pixels, een horizontale marge van 12 pixels en een grijze achtergrond.
...
**Voorbeeld** - Als u de begintijd van een hoofdstuk wilt instellen met grijs 10 pixels, verdana-lettertype en een opvulling van tien pixels aan de rechterkant.
...
<table id="table_BC6AFB57D9404A84A3AE657448C0EB06"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Breedte randaansluiting. </p> <p>Gedefinieerd als <span class="codeph"> &lt;width&gt; &lt;width&gt; 0 </span> zodat dezelfde breedte alleen voor de boven- en horizontale randen wordt gedefinieerd en de onderste rand de volgende breedte heeft: <span class="codeph"> 0 </span>. </p> </td> 
  </tr> 
  <tr> 
...
**Voorbeeld** - Voor het instellen van een grijze wigge connector van zes pixels:
