...
Als u deze knop selecteert of tikt, zoomt u in op een afbeelding in de hoofdweergave. Deze knop wordt weergegeven in de hoofdbesturingsbalk. Deze knop wordt niet weergegeven op mobiele telefoons om de schermruimte op te slaan. U kunt deze knop vergroten, verkleinen, verkleinen en plaatsen met CSS.
...
Voorbeeld - Een inzoomknop instellen van 28 x 28 pixels en geplaatst op 4 pixels van de onderkant en 103 pixels van de rechterrand van de hoofdbesturingsbalk. En tenslotte, toont een verschillend beeld voor elk van de vier verschillende knoopstaten.
