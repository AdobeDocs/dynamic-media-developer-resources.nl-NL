...
Voorbeeld - Als u een bericht wilt instellen dat een lettertype van tien punten vet wordt gebruikt, hebt u een regelhoogte van 25 pixels, een opvulling van 20 pixels aan de linkerkant en een uitroeptekenpictogram. En ten slotte, rode tekst als er een fout is, en geen pictogram en groene tekst als er succes is:
