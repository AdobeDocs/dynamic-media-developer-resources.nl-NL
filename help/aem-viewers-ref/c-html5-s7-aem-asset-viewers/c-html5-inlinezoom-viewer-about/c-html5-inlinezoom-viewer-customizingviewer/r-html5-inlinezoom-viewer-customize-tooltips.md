...
>[!NOTE]
>
>Als knopinfo-stijlen worden aangepast vanuit de ingesloten webpagina, moeten alle eigenschappen `!IMPORTANT` regel. Het is echter niet nodig of knopinfo in het CSS-bestand van de viewer wordt aangepast.
