...
Als u deze knop selecteert, gaat de gebruiker naar de volgende pagina in de catalogus. Deze knop wordt weergegeven in de hoofdbesturingsbalk. Deze knop wordt niet weergegeven op mobiele telefoons om de schermruimte op te slaan. U kunt deze knop vergroten, verkleinen, verkleinen en plaatsen met CSS.
...
Voorbeeld - Een knop voor de volgende pagina instellen van 28 x 28 pixels en een positie 4 pixels vanaf de onderrand en 250 pixels vanaf de rechterrand van de hoofdbesturingsbalk. En tenslotte, toont een verschillend beeld voor elk van de vier verschillende knoopstaten.
