...
>[!NOTE]
>
>Deze knop ondersteunt de `state` en `selected` kenmerkkiezers, die kunnen worden gebruikt om verschillende skins toe te passen op verschillende knoptoestanden.
>
>Met name: `selected='false'` komt overeen met de oorspronkelijke toestand van de schuifknop, en `selected='true'` komt overeen met de status wanneer het deelvenster Zoeken actief is.
