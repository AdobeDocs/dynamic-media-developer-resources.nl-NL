...
>
>Dit komt met name overeen met `selected='false'` `selected='true'` de eerste status van de schuifknop en komt overeen met de status wanneer het deelvenster Zoeken actief is.
