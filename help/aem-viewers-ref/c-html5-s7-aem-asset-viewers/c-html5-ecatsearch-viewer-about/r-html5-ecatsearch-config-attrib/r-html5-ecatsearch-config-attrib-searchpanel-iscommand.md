...
<table id="table_9E7BB12BF371419F88DD4D24EF04632C"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> De opdrachtreeks Beeldbewerking die op alle miniaturen wordt toegepast. Indien opgegeven in de URL, moeten alle instanties van <span class="codeph"> &amp;</span> en <span class="codeph"> =</span> HTTP-gecodeerd zijn als respectievelijk <span class="codeph"> %26</span> en <span class="codeph"> %3D</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
