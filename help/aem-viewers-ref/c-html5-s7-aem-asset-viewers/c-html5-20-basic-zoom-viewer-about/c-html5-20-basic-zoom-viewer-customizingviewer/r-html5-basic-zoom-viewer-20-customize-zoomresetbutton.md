...
description: Als u deze knop selecteert, wordt een afbeelding opnieuw ingesteld in de hoofdweergave. U kunt deze knop vergroten, verkleinen, verkleinen en plaatsen met CSS.
...
Als u deze knop selecteert, wordt een afbeelding opnieuw ingesteld in de hoofdweergave. U kunt deze knop vergroten, verkleinen, verkleinen en plaatsen met CSS.
...
Voorbeeld - om een knop voor het opnieuw instellen van zoomen in te stellen met een grootte van 32 x 32 pixels en zes pixels vanaf de boven- en rechterrand van de viewer. Er moet een andere afbeelding worden weergegeven voor elk van de vier verschillende knopstatussen.
