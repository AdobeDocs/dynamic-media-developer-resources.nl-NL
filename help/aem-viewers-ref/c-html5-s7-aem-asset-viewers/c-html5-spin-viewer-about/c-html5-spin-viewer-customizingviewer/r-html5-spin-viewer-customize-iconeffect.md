...
De centrifugeindicator ondersteunt de `state` kenmerkkiezer die is ingesteld op `spin_1D` in het geval van een eendimensionale centrifuge en op `spin_2D` in het geval van een multidimensionale centrifugeerset.
