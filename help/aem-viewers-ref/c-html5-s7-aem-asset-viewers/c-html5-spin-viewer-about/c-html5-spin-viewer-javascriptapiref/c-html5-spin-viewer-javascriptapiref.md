...
# JavaScript API-referentie voor de centrifuge-viewer{#javascript-api-reference-for-spin-viewer}
...
In alle volgende voorbeelden staat `<instance>` voor de werkelijke naam van het JavaScript-viewerobject dat van de `s7viewers.SpinViewer` klasse is geïnstantieerd.
