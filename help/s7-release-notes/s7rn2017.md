---
description: De meest recente release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de oplossing Adobe Experience Manager in de Adobe Experience Cloud.
seo-description: De meest recente release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de oplossing Adobe Experience Manager in de Adobe Experience Cloud.
seo-title: Opmerkingen bij de release Dynamic Media
title: Opmerkingen bij de release Dynamic Media
...
# Opmerkingen bij de release Dynamic Media{#dynamic-media-release-notes}

De meest recente release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de oplossing Adobe Experience Manager in de Adobe Experience Cloud.

## Opmerkingen bij de release Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

De meest recente release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de [!DNL Adobe Experience Manager] oplossing in de [!DNL Adobe Experience Cloud].
...
* HTML5-video
   ...
   * Videobijschriften vereisen een bedrijfsregels als het hosten van de HTML-pagina wordt bediend van een externe server (geen Dynamic Media server). Neem contact op met de Technische Ondersteuning van Adobe voor hulp.
