...
De nieuwste release bevat informatie over Adobe Dynamic Media Classic als onderdeel van de Adobe Experience Manager-oplossing in de Adobe Experience Cloud.

## Opmerkingen bij de release van Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

De meest recente release bevat informatie over de [!DNL Adobe Experience Manager] in de [!DNL Adobe Experience Cloud].
...
Voor volledige documentatie raadpleegt u  [https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro)
...
* Verwijderd **SPSAdmin maken** door beveiligingsproblemen.
...
* Algemeen
   ...
   * Schalen aan de browserzijde kan de interface en afbeeldingen vervagen wanneer de gebruiker inzoomt op de pagina. UI-opmaak wordt mogelijk ook onjuist weergegeven, afhankelijk van zoomen. Dit effect wordt op volledig scherm weergegeven.
...
* HTC mobiele apparaten
   ...
   * De mobiele apparaten van HTC in Adobe tonen het onvermogen aan om inheems knijpbeweging onbruikbaar te maken een &quot;eigenschap&quot;van de omslag van de Htc UI (HTC Sense) is. Door dit probleem kan de hele pagina worden ingezoomd wanneer een zoombeweging met een knijpbeweging in de viewer wordt gebruikt. Stel voor dat u dubbeltikt.
...
* HTML5-video
   ...
   * Videobijschriften vereisen een bedrijfsregels als het hosten van de HTML-pagina wordt verzorgd door een externe server (niet door een Dynamic Media-server). Neem contact op met de ondersteuning van Adobe.
