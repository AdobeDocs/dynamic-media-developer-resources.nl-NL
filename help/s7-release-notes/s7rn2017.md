---
description: De nieuwste release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de Adobe Experience Manager-oplossing in de Adobe Experience Cloud.
seo-description: De nieuwste release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de Adobe Experience Manager-oplossing in de Adobe Experience Cloud.
seo-title: Opmerkingen bij de release van Dynamic Media
...
De nieuwste release bevat informatie over Adobe Dynamic Media Classic, een onderdeel van de Adobe Experience Manager-oplossing in de Adobe Experience Cloud.

## Opmerkingen bij de release van Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

De nieuwste releaseopmerkingen voor Adobe Dynamic Media Classic-deel van de [!DNL Adobe Experience Manager]-oplossing in de [!DNL Adobe Experience Cloud].
...
Voor volledige documentatie, zie [http://help.adobe.com/en_US/scene7/using/index.html](http://help.adobe.com/en_US/scene7/using/index.html)
...
* HTML5-video
   ...
   * Voor videobijschriften is een bedrijfsregel vereist als de HTML-pagina wordt gehost vanaf een externe server (niet vanaf een Dynamic Media-server). Neem contact op met de ondersteuning van Adobe.
