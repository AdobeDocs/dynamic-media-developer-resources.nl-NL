---
description: In de meest recente versie vindt u een beschrijving van de nieuwste functies, verbeteringen en oplossingen voor het Adobe Scene7 Publishing System 6.8-onderdeel van de Adobe Experience Manager-oplossing in de Adobe Marketing Cloud.
seo-description: In de meest recente versie vindt u een beschrijving van de nieuwste functies, verbeteringen en oplossingen voor het Adobe Scene7 Publishing System 6.8-onderdeel van de Adobe Experience Manager-oplossing in de Adobe Marketing Cloud.
...
In de meest recente versie vindt u een beschrijving van de nieuwste functies, verbeteringen en oplossingen voor het Adobe Scene7 Publishing System 6.8-onderdeel van de Adobe Experience Manager-oplossing in de Adobe Marketing Cloud.

## Opmerkingen bij de release Scene7 Publishing System 6.8 (mei 2014) {#topic-4517aab837ea4d6d8204425958860e5a}

In de meest recente versie vindt u een beschrijving van de nieuwste functies, verbeteringen en oplossingen voor [!DNL Adobe Scene7 Publishing System] 6.8-onderdelen van de Adobe Experience Manager-oplossing in de [!DNL Adobe Marketing Cloud]wizard.
...
* Converteer het e-mailadres Wachtwoord vergeten van HTML naar normale tekst om zwarte lijsten te voorkomen.
...
* Er is een waarschuwingsbericht toegevoegd wanneer u de configuratie van Adobe Analytics bewerkt en vervolgens probeert te ontsnappen uit de installatie zonder dat u dit hoeft op te slaan.
...
* Vast: methode wordt niet geactiveerd wanneer deze is ingesloten in de `selectSwatch` `initViewer()` functie.
...
* Vast: Het HTTPS-protocol genereert een beveiligingswaarschuwing in IE8 met behulp van het afspelen van Flash.
