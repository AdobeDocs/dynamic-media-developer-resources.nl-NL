---
description: In de meest recente versie vindt u een beschrijving van de nieuwe functies, verbeteringen en oplossingen voor het Adobe Scene7 Publishing System 6.10-onderdeel van de Adobe Experience Manager-oplossing in de Adobe Marketing Cloud.
seo-description: In de meest recente versie vindt u een beschrijving van de nieuwe functies, verbeteringen en oplossingen voor het Adobe Scene7 Publishing System 6.10-onderdeel van de Adobe Experience Manager-oplossing in de Adobe Marketing Cloud.
...
In de meest recente versie vindt u een beschrijving van de nieuwe functies, verbeteringen en oplossingen voor het Adobe Scene7 Publishing System 6.10-onderdeel van de Adobe Experience Manager-oplossing in de Adobe Marketing Cloud.
...
* **Zoektype** - Mogelijkheid om bedrijfbezit toe te voegen om gebrek van persoonlijk onderzoekstype toe te staan **[!UICONTROL bevat]**.

   In **[!UICONTROL Opstelling]** > de groep van de **[!UICONTROL Persoonlijke Opstelling]** > **[!UICONTROL Browser]** rubriek > de drop-down lijst van het Type **[!UICONTROL van het Onderzoek van de]** Basis - **[!UICONTROL Bevat]**.
...
Kies in **[!UICONTROL Application Setup]** > **[!UICONTROL General Settings]** group > **[!UICONTROL Other Settings de vervolgkeuzelijst Application]** group > **[!UICONTROL Default Basic Search Type for New Users]** .
...
* **Er zijn nieuwe instellingen toegevoegd aan de out-of-the-box HTML5 Spin Set Viewers** - In **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewers]** > **[!UICONTROL Viewer Presets]** > `Universal_HTML5_SpinSet_dark` `Universal_HTML5_SpinSet_light`[!DNL Configure Viewer] of de volgende toevoegingen aangebracht op de respectievelijke  van elke viewer:
...
* **Er zijn nieuwe instellingen toegevoegd aan externe viewers voor gemengde HTML5-mediasets** - In **[!UICONTROL Setup]** > **[!UICONTROL Toepassingsinstelling]** > **[!UICONTROL Voorinstellingen]** van `Universal_HTML5_MixedMedia_dark` viewer > `Universal_HTML5_MixedMedia_light`of [!DNL Configure Viewer] de volgende toevoegingen zijn aangebracht op de respectievelijkepagina van elke viewer:
...
* PSD-hoofdbestand is meerdere keren geregistreerd als gepubliceerd per afbeeldingsserver.
...
* Geïmplementeerde gebruikersinterface voor het maken en bijwerken van metagegevensvelden van het type tag. Ondersteuning voor de **[!UICONTROL metagegevensveldtypen]** in de `fieldType` parameter is `SingleFixedTag` alleen en `BooleanTag` alleen beschikbaar.
...
* Er is een fout opgetreden bij het toevoegen van een door gebruiker gedefinieerd veld ( **[!UICONTROL Instellen]** > **Metagegevens** > **Door gebruiker gedefinieerd veld**) van het type `Boolean`en een waarde van `true`, en het vervolgens opslaan.
