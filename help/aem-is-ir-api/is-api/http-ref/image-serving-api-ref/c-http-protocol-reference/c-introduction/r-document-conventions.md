...
<table id="simpletable_8C9DB0DA5F2B4C068794415602B768CB"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Een naam met een navolgende '=' verwijst naar een Beeld dat het bevel van het Protocol van HTTP dient. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> attribute::Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam vooraf ingesteld met <span class="codeph"> kenmerk: </span> verwijst naar een kenmerk van een afbeeldingscatalogus. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> catalogus::Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam die vooraf is voorzien van <span class="codeph"> catalogus: </span> verwijst naar een gegevensveld voor een afbeeldingscatalogus. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> icc::Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam vooraf voorzien van <span class="codeph"> icc: </span> verwijst naar een veld in de ICC-kleurenprofielkaart. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> font::Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam die vooraf is ingesteld met <span class="codeph"> lettertype: </span> verwijst naar een veld in de lettertypekaart. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> macro: Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam vooraf met <span class="codeph"> macro: </span> verwijst naar een veld in de macrodefinitietabel. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> regels:Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam die vooraf met <span class="codeph"> regels is ingesteld: </span> verwijst naar een element in een URL-voorverwerkingsregelset. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> default::Item </span> </p> </td> 
  <td class="stentry"> <p>Een naam die vooraf is ingesteld met de <span class="codeph"> standaardwaarde: </span> verwijst naar een kenmerk van de standaardafbeeldingscatalogus. </p> </td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> *[ <span class="varname"> optioneel </span>] </span> </p> </td> 
  <td class="stentry"> <p>Het <span class="varname"> optionele </span> syntaxiselement mag nooit of vaker worden herhaald. </p> </td> 
 </tr> 
 <tr class="strow"> 
