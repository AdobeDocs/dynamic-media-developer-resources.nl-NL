 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>De Beeldserver herkent ook de volgende RTF-onderstrepende opdrachten: </p> <p> 
     ...
     </ul> </p> <p>Deze worden momenteel als standaard geïmplementeerd <span class="codeph"> \ul </span> onderstrepen. Alle andere onderstrepende RTF-opdrachten worden genegeerd. </p> </td> 
  </tr> 
  <tr> 
