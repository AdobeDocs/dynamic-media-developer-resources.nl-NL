 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>De Beeldserver herkent ook de volgende RTF-onderstrepende opdrachten: </p> <p> 
     ...
     </ul> </p> <p>Deze worden op dit moment geïmplementeerd als een standaard <span class="codeph"> \ul </span> onderstrepen. Alle andere onderstrepende RTF-opdrachten worden genegeerd. </p> </td> 
  </tr> 
  <tr> 
