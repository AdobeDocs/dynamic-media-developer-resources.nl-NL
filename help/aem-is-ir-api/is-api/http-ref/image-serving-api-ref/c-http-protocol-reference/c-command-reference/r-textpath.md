...
>[!NOTE]
>
>Anders dan `clipPath=`, worden de tekstwegen niet automatisch gesloten wanneer &quot;z&quot;of &quot;Z&quot;niet aan het eind van een subweg wordt gespecificeerd.
...
Kenmerk tekstlaag ( `textPs=` alleen). Genegeerd door andere lagen. Is van toepassing op `layer=0` indien opgegeven voor `layer=comp`. Genegeerd als `textPs=` aanwezig is.

Er wordt een fout geretourneerd als een laag zowel `textPath=` als `textFlowPath=`.
