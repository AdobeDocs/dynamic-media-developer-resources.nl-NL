...
In het geval van afbeeldings- en tekstlagen `color=` worden transparante en semi-dekkende gebieden binnen het selectiekader van de laag gevuld met de opgegeven kleur* voor* `rotate=` en `extend=` toegepast.
