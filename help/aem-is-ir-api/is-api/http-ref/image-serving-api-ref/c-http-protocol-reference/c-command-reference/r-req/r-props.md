...
<table id="table_9665612ED7D24C07AAF75D953C0FEB36"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> string </p> </td> 
   <td> <p> Afbeeldingstype beantwoorden, kan <span class="codeph"> CMYK </span>, <span class="codeph"> RGB </span> of <span class="codeph"> BW </span> (voor grijswaardenafbeeldingen). </p> </td> 
  </tr> 
  <tr valign="top"> 
...
De volgende eigenschappen worden geretourneerd voor `/is/content` verzoeken:
