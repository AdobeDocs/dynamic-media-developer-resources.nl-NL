...
<table id="simpletable_39B9638BCB0F4244B5155C958C044C31"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Druk een synopsis aan <span class="codeph"> stdout af </span>. </p> </td> 
 </tr> 
 <tr class="strow"> 
...
Voor Windows is de bestandsnaam [!DNL playlog.bat] en voor Linux is dit [!DNL playlog.sh].
