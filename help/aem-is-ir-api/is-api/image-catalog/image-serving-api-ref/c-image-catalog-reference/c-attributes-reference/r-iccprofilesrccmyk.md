...
Overgenomen van `default::IccProfileSrcCmyk` indien niet gedefinieerd of indien leeg. Als de resolutie `attribute::IccProfileSrcCmyk` niet wordt omgezet naar een geldig profiel, wordt in plaats daarvan `attribute::IccProfileCmyk` gebruikt.
