...
SVG-gegevensbestanden worden na alle bestanden met afbeeldingsgegevens in de opgegeven volgorde geladen. Als dezelfde `catalog::Id` waarde voorkomt in meer dan één record (in dezelfde of andere afbeelding of in SVG-catalogusbestanden), heeft de laatste instantie voorrang.
