...
Een lege *`locale`* waarde komt overeen met lege en onbekende `locale=` tekenreeksen. Hiermee kunt u een standaardregel voor onbekende landinstellingen definiëren.

Lege *`locId`* waarden zijn toegestaan en selecteer de waarde *`defaultString`* (de landinstellings-id *`defaultString`* is niet beschikbaar). *`locId`* waarden worden doorzocht in de opgegeven volgorde. De eerste overeenkomst wordt geretourneerd.
...
<table id="table_EE0321F9890B45CA8C364178F5100D40"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>De waarde van een willekeurig <span class="filepath"> doel.*.label </span> en <span class="filepath"> doel.*.userdata, </span> eigenschap. </p> </td> 
  </tr> 
  <tr valign="top"> 
