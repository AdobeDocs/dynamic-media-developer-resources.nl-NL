...
Beperkt de grootte van beelden de Server van het Beeld aan dossiers met het `req=saveToFile` bevel zal schrijven. Geheel getal groter dan 0 in miljoenen pixels. Er wordt een fout geretourneerd als de opslagbewerking de limiet overschrijdt. De standaardwaarde is 100 miljoen pixels.
