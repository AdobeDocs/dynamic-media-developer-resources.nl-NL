...
De map waarnaar de platformserver logbestanden schrijft. Dit kan een absoluut pad zijn of een pad ten opzichte van *`install_folder`*. De standaardwaarde is [!DNL  *`install_folder`*/logs].
...
Het voorvoegsel van de naam voor het bestand waarnaar de gegevens van het toegangslogboek worden geschreven. De datum en het achtervoegsel van het bestand ( [!DNL  *`yyyy`*- *`mm`*- *`dd`*.log]) worden aan de opgegeven tekenreeks toegevoegd. De naam van het toegangslogboekdossier moet van dat van het dossier van het spoorlogboek verschillend zijn. Standaard is &quot; `access-`&quot;.
...
Als u het opwarmhulpprogramma voor cache wilt gebruiken, moeten spaties worden gebruikt als veldscheidingstekens. De platformserver vervangt alle spaties en &#39;%&#39; tekens in veldwaarden door `%20` respectievelijk en `%25`.
...
<table id="table_7A07AFF34B5040A5B30F5735CFE9428F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>datum en tijd, opgemaakt als <span class="codeph"> yyyy <span class="varname"> - </span>MM <span class="varname"> - </span>dd <span class="varname"></span> HH <span class="varname"> </span>: <span class="varname"> mm </span>: <span class="varname"> ss </span>. <span class="varname"> SSS- </span> verschuiving </span> </p> <p> ( <span class="varname"> SSS </span> is msec, <span class="varname"> offset </span> is de GMT-tijdverschuiving); de tijdwaarde wordt vastgelegd wanneer de reactie naar de client wordt verzonden. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <p> <span class="codeph"> %R </span> </p> </td> 
   <td> <p>Hetzelfde als <span class="codeph"> %r </span>, maar past beperkte HTTP-codering toe op de URI om problemen met het parseren van logbestanden te voorkomen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Cachecode platformserver (map/naam cachebestand). </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> %{CacheUse}r </span> </p> </td> 
   <td> <p>Trefwoord voor platformoverbeheer voor servercache: <span class="codeph"> { REEUSED| GECREËERD| BIJGEWERKT| EXTERN| REMOTE_CREATED| REMOTE_UPDATED| REMOTE_CACHE| GEVALIDEERD| GENEGEERD| ONGEDEFINIEERD } </span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>De koptekstwaarde van de <span class="codeph"> tabreactie </span> (MD5-handtekening van de reactiegegevens). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>IP adres van de peer server in de geheim voorgeheugencluster die de geheim voorgeheugeningang of "-"leverde als <span class="codeph"> Geheime voorgeheugenGebruik </span> noch <span class="codeph"> REMOTE_CREATED </span> noch <span class="codeph"> REMOTE_UPDATED is </span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>De tijd het neemt de Server van het Platform om reactie te verzenden na het schrijven van gegevens naar de outputstroom. </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> %{Size}r </span> </p> </td> 
   <td> <p>Net als <span class="codeph"> %B </span>, maar inclusief waarden voor 304 (niet-gewijzigde) reacties. </p> </td> 
  </tr> 
  <tr> 
