...
De gegevens worden opgemaakt als één `name=value` eigenschap per tekstrecord. Tekenreekswaarden worden niet vermeld. Waarschuwing- en foutberichten worden altijd naar verzonden, `stderr`zelfs als `-log` dit is opgegeven.
...
<table id="simpletable_32AAA1A2DDB04BC6B86885E6223BF609"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph">glazen=<span class="varname"> ivaal</span></span> </p></td> 
  <td class="stentry"> <p><span class="varname"> ival</span> is 1 als de behuizing glazen deuren bevat, 0 in andere gevallen. Alleen stijlen voor kabinetten. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph">iccProfile=<span class="varname"> string</span></span> </p></td> 
  <td class="stentry"> <p>De naam van het ingesloten iccProfile in het <span class="varname"> sourceFile</span>. </p> <p>Leeg als <span class="varname"> sourceFile</span> geen kleurbeheer heeft. Alleen vignetten. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p><span class="varname"> ival</span> is 1 als <span class="varname"> sourceFile</span> een hoofdvignet is, 0 als het eerder met <span class="filepath"> vnUpdate</span> of <span class="filepath"> vntc</span>is verwerkt. Alleen vignetten. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph">master=<span class="varname"> ival</span></span> </p></td> 
  <td class="stentry"> <p><span class="varname"> ival</span> is 0 als <span class="varname"> sourceFile</span> een kabinetstijl is die JPEG-afbeeldingsgegevens bevat (in dit geval wordt ook een waarschuwing weergegeven), anders 1. Alleen kabinet en venster dat stijlbestanden bedekt. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph">maxMem=<span class="varname"> string</span></span> </p></td> 
  <td class="stentry"> <p>De maximale geheugenlimiet die van toepassing is op het actieve <span class="filepath"> vntc</span> -proces. <span class="varname"> De tekenreeks</span> is <span class="varname"> ival</span>, <span class="varname"> ivalK</span>, <span class="varname"> ivalM</span>, <span class="varname"> ivalG</span>of <span class="codeph"></span> 0 uitgeschakeld. Waar <span class="varname"> K</span>, <span class="varname"> M</span>, en <span class="varname"> G</span> naar Kilobytes (1024 bytes), Megabytes (1048576 bytes), en gigabytes (1073741824 bytes) verwijzen. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Het aantal materialen dat in het <span class="varname"> bronbestand</span>is opgeslagen. Alleen vignetten. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Het volledig gekwalificeerde <span class="varname"> bronbestandspad</span> . </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p><span class="codeph"> vnt</span> als <span class="varname"> sourceFile</span> een vignet is, <span class="codeph"> vnc</span> als <span class="varname"> sourceFile</span> een kabinetstijl is, of <span class="codeph"> vnw</span> als <span class="varname"></span> sourceFile een vensteromslagstijl is. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p><span class="varname"> ival</span> is 1 als de stijl van het kabinet texturable is, 0 anders. Niet aanwezig voor vignetten en vensterbekledingsstijldossiers. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph">waarschuwing.<span class="varname"> n</span>=<span class="varname"> string</span></span> </p></td> 
  <td class="stentry"> <p>Waarschuwingsbericht (bijvoorbeeld wanneer <span class="codeph"> -imagemap</span> is opgegeven, maar er geen kaartgegevens in het vignet zijn gevonden). </p></td> 
 </tr> 
</table>
