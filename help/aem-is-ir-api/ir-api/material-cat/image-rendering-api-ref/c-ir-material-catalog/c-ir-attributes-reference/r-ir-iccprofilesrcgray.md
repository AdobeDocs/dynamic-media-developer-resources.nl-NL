...
Overgenomen van `default::IccProfileSrcGray` indien niet gedefinieerd of indien leeg. Als de resolutie `attribute::IccProfileSrcGray` niet wordt omgezet in een geldig profiel, wordt in plaats daarvan `attribute::IccProfileGray` gebruikt.
