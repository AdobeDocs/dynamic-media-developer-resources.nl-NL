...
Cataloguskenmerkbestanden bestaan uit een set tekstrecords, gescheiden door één `<CR>` (ASCII-code 0xD), één `<LF>` (ASCII-code 0xA) of `<CR><LF>` paar. Elke record bestaat uit een kenmerknaam en een of meer door komma&#39;s gescheiden kenmerkwaarden:
...
<table id="simpletable_8454AD549FDA421BA1469CDA44132773"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Kenmerkwaarde; mag geen <span class="codeph"> &lt;CR&gt;- </span>of <span class="codeph"> &lt;LF&gt;- </span> tekens bevatten, tenzij deze worden beschermd door één backslash vlak voor het nieuwe-regelteken. </p> </td> 
 </tr> 
</table>
