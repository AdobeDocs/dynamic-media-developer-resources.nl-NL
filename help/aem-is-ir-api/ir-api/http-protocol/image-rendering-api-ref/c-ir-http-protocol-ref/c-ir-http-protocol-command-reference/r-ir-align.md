...
Elk object kan maximaal 6 oorsprongspunten definiëren (0,1, 3, 4, 5, 6). Als een `align` waarde wordt opgegeven maar het corresponderende oorsprongpunt niet door het vignetobject wordt gedefinieerd, wordt het standaardoorsprongpunt (midden-overeenkomst) gebruikt.
