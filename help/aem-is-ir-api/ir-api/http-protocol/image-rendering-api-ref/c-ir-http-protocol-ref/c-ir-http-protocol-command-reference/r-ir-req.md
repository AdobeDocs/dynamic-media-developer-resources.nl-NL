...
Hiermee worden de geselecteerde eigenschappen geretourneerd van het vignetbestand of de catalogusvermelding die is opgegeven in het URL-pad. Zie [Eigenschappen](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-response-data/c-ir-properties.md#concept-e99f1a373eae4af9b41842ca0088ad3a) voor een beschrijving van de antwoordsyntaxis en het MIME-type reactie. Andere opdrachten in de aanvraag worden genegeerd. De volgende eigenschappen worden geretourneerd:
...
<table id="table_A30296D29B5D43F1B5383A887252C6B4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>String </p> </td> 
   <td colname="col3"> <p>Wijzigingsdatum/-tijd (van <span class="codeph"> catalogus::TimeStamp </span> of het vignetbestand). </p> </td> 
  </tr> 
  <tr> 
...
Een XML-document met een lege `<map>` -element wordt geretourneerd als het vignet geen kaartgegevens bevat.

`object`

Hiermee worden de opgegeven opdrachten uitgevoerd en wordt de gerenderde afbeelding geretourneerd die is gemaskeerd door de selectie van het resterende object (de groep of het object dat is geselecteerd met de laatste `sel=` of `obj=` in de aanvraag). Wordt meestal gebruikt met een afbeeldingsindeling die alfa ondersteunt (zie [fmt=](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-fmt.md#reference-4c743f67d56b47c5b774fcc900ff758c)). Als een afbeeldingsindeling wordt gebruikt die geen alfa ondersteunt, zijn de gebieden buiten het masker zwart.
...
<table id="table_F3ECF0584F6247A2A75C1CAFE1C57A4E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p> <span class="codeph"> selecteren <span class="codeph"> selection.attributes </span>ion.name </span> </p> </td> 
   <td> <p> String </p> </td> 
