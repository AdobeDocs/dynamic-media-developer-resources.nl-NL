...
Er kan één decal worden toegepast op elk vlak, stroomlijn, schets, vlak of wandobject (tenzij de markering Geen structuur is ingesteld). Decals worden toegepast op het object door het decal `anchor=` uit te lijnen met het decimale oorsprongpunt van het vignetobject. De positie kan verder worden aangepast met `pos=`.
