...
---
# Richtlijnen voor het bijdragen aan de documentatie van Adobe Dynamic Media Developer Resources

## Documentatiefilosofie

Adobe weet dat Adobe Dynamic Media-gebruikers werken in zeer concurrerende omgevingen en streven naar het creëren van digitale ervaringen die hen onderscheiden van hun concurrenten. Daarom is het van essentieel belang dat wanneer Adobe geavanceerde nieuwe hulpmiddelen levert, deze hulpmiddelen met nauwkeurige en duidelijke documentatie worden aangevuld om de klant in staat te stellen hun Dynamic Media-investering onmiddellijk te benutten en het rendement van investeringen te maximaliseren.
...
Alle ideeën die u eventueel nodig hebt om de documentatie te verbeteren, zijn welkom als bijdragen. Opmerkingen, problemen en intrekkingsverzoeken zijn echter bedoeld voor *bijdragen* alleen. Ze zijn niet bedoeld om je vragen te beantwoorden over hoe je Dynamic Media kunt gebruiken, je project kunt implementeren of technische problemen kunt oplossen.

Eventuele vragen over het gebruik van Dynamic Media of technische fouten moeten via de [Enterprise Support-portal van Experience Cloud](https://experienceleague.adobe.com/nl?support-solution=General&amp;support-tab=home#support) of in de [Experience Manager-gemeenschap.](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community)
...
[De Microsoft®-handleiding](https://learn.microsoft.com/en-us/style-guide/welcome/) is een vrij beschikbare documentatie stijlgids die zich op softwaredocumentatie en de documentatie van Dynamic Media concentreert volgt waar mogelijk deze gids.
...
Markeertekens of andere annotaties in schermafbeeldingen (zoals rode kaders, pijlen of tekst) mogen niet worden gebruikt. De reden hiervoor is dat schermafbeeldingen eenvoudiger te hergebruiken of te repliceren zijn in gelokaliseerde versies van de documentatie.
